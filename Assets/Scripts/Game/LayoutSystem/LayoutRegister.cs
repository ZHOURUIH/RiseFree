...
public class LayoutRegister : GameBase
{
	public void registeAllLayout()
	{
        ...
        registeLayout<ScriptVolumeSetting>(LAYOUT_TYPE.LT_VOLUME_SETTING, "UIVolumeSetting");
	...
	protected bool assign<T>(ref T thisScript, LayoutScript value, bool created = true) where T : LayoutScript
	{
