...
public class PacketHeader
{
	...
	public PacketHeader(byte reportID)
	{
		mReportID = reportID;
		mMagicByte = 0xA5;
		mVersion = 0;
		...
		mCRC16 = 0;
		mSeqID = 0;
		mHeaderLength = sizeof(byte) + sizeof(byte) + sizeof(byte) + sizeof(ushort) + sizeof(ushort) + sizeof(ushort);
	}
	...
	public byte[] toBytes()
	{
		...
		int offset = 0;
		BinaryUtility.writeByte(data, ref offset, mReportID);
